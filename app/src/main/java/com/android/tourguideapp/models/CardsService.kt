...
//        val indexToDelete = cards.indexOfFirst { it.id == card.id }
//        if (indexToDelete != -1){
...
//    }
//
//    fun moveCard(card: Card, moveBy: Int){
//        val oldIndex = cards.indexOfFirst { it.id == card.id }
//        if(oldIndex == -1) return
//        val newIndex = oldIndex+moveBy
//        if(newIndex<0 || newIndex>= cards.size)return
//        Collections.swap(cards,oldIndex,newIndex)
//        notifyChanges()
//    }
