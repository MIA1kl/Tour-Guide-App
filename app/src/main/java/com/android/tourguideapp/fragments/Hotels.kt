...
class Hotels : Fragment() {
    ...
    override fun onCreateView(
        ...
        val placeList = mutableListOf<Card>(
            Card(1,"https://images.unsplash.com/photo-1600267185393-e158a98703de?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=600&ixid=MnwxfDB8MXxyYW5kb218fHx8fHx8fHwxNjI0MDE0NjQ0&ixlib=rb-1.2.1&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=800","Nature","auwyeuyuauiwyefuusyuayduyi","+996555555555","Moskva st.234")
        )
